...
export const FALLBACK_MODELS: ModelOption[] = [
  ...
  },
  {
    ...
    description: 'Gemini 3 Flash 프리뷰 분석 모델',
    supportedActions: ['generateContent'],
    task: 'analysis',
    selectable: true,
    source: 'default',
  },
  {
    ...
    description: '효율 중심의 안정화 멀티모달 분석 모델',
    supportedActions: ['generateContent'],
    task: 'analysis',
    selectable: true,
    source: 'default',
  },
  {
    ...
    description: '최신 Flash 계열을 가리키는 분석 별칭',
    supportedActions: ['generateContent'],
    task: 'analysis',
    selectable: true,
    source: 'default',
  },
  {
    ...
    description: '최신 Flash-Lite 계열을 가리키는 분석 별칭',
    supportedActions: ['generateContent'],
    task: 'analysis',
    selectable: true,
    source: 'default',
  },
  {
    ...
    description: 'Gemini 2.5 고성능 분석 모델',
    supportedActions: ['generateContent'],
    task: 'analysis',
    selectable: true,
    source: 'default',
  },
  {
    ...
    description: 'Gemini 2.5 범용 멀티모달 분석 모델',
    supportedActions: ['generateContent'],
    task: 'analysis',
    selectable: true,
    source: 'default',
  },
  {
    ...
    description: 'Gemini 2.5 저비용 멀티모달 분석 모델',
    supportedActions: ['generateContent'],
    task: 'analysis',
    selectable: true,
    source: 'default',
...
export const SKIN_REDNESS_MODERATION_INSTRUCTION = `Whenever visible skin appears red or flushed, describe it only as "slightly red" or "slightly flushed". In Korean output, use only "살짝 붉은" or "아주 약한 홍조". Never emphasize or intensify skin redness beyond "slightly". Do not introduce skin redness when it is not visible, and do not apply this rule to clothing, makeup, lighting, or the background.`;
